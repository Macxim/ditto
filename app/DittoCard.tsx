    ...
    <Link href={`/dittos/${ditto.slug}`} className="group block">
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-500 glass flex items-center justify-center translate-y-2 group-hover:translate-y-0">
            <div className="flex flex-col items-center gap-3">
              <span className="text-4xl translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-75">
                〃
              </span>
              <span
        ...
        <div className="px-6 py-6 md:px-10 md:py-9">
          <div className="flex items-start justify-center gap-8">
            ...
            <div className="flex flex-col items-end gap-4">
              ...
              <span
                className="text-xs shrink-0 tabular-nums opacity-70 font-mono mt-1"
                style={{ color: "var(--app-muted)" }}
              >
                #{ditto.slug}
              </span>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, var(--app-text), transparent)",
          }}
        />
      </article>
    </Link>
